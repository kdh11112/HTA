...
<html>
    ...
    <%
    	...
    	int totalCount = dao.getTotalCount("임시",eNum);
    	//페이징 10개씩
                            ...
                            <div class="card-body">
                                <table class="table table-striped .w-auto">
                                    ...
                                    <%
                                    	...
                                    	ArrayList<ApprovalVO> list = dao.selectTemp(startNo,endNo,eNum);
                                ...
                                <tr>
                                	...
                                	<nav aria-label="Page navigation example">
									  <ul class="pagination">
									    <li class="page-item">
									      <a class="page-link" href="approvalListTemporary.jsp?pageNum=<%=prevPage %>" aria-label="Previous">
                                	...
                                	%>
									    <li class="page-item">
									  <a class="page-link" href="approvalListTemporary.jsp?pageNum=<%=i%>"> <%=i %></a>
									    </li>
                                	<%
                                		}
                                	%>
									    <li class="page-item">
									      <a class="page-link" href="approvalListTemporary.jsp?pageNum=<%=nextPage %>" aria-label="Next">
