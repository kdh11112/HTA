...
<div id="container" class="container">
    ...
    <div class="row">
      <!-- SIGN UP -->
      <div class="col align-items-center flex-col sign-up" style="overflow-y: auto; max-height: 1000vh;">
        <div class="form-wrapper align-items-center">
          <div class="form sign-up">
            ...
            <div class="input-group">
              <i class='bx bxs-postcode'></i>
              <input id="postcode" type="text">
              <input type="button" value="우편번호찾기" id="addrbtn"/><br />
              도로명: <input type="text" id="address1"/><br /> 
            ...
            <div class="input-auth">
              <i class='bx bxs-certificationNumber'></i>
              <input id="birth" type="date" >
            </div>
