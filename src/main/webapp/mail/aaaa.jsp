...
$(document).ready(function() {
  ...
  // "메일쓰기" 버튼 클릭 이벤트 처리
  $("#write").off("click").on("click", function() {
    // AJAX를 사용하여 mail_write.jsp 페이지를 로드하여 right_main 클래스 내에 표시
    $.ajax({
      url: "mail_write.jsp",
      dataType: "html",
      success: function(response) {
  ...
  $("#inbox").off("click").on("click", function() {
    // AJAX를 사용하여 mail_all_inbox.jsp 페이지를 로드하여 right_main 클래스 내에 표시
    $.ajax({
      url: "mail_all_inbox.jsp",
      dataType: "html",
      success: function(response) {
        $(".right_main").html(response);
      },
  ...
  // "내게 쓴 메일함" 버튼 클릭 이벤트 처리
  $("#my_inbox").off("click").on("click", function() {
